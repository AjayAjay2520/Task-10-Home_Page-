...
import cardImg2 from "./Gallery/hogenakkal1 (3).jpeg";
import cardImg3 from "./Gallery/hogenakkal1 (2).jpeg";
    ...
    <div>
      ...
      <div className="d-flex">
        <div style={{ marginLeft:"0px", marginTop: "10px" }}>
          ...
          >
            <Modal.Dialog style={{ width: "600px",height:"500px" }} className="ms-4">
